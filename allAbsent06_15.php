...
?>
    ...
    <table class='searchResults'>
        ...
        <?php
        $queryall = "Select DISTINCT e.indexNo, c.regNo, s.nameEnglish,s.addressE1 from crs_enroll c,student_a s,exameffort e where  c.yearEntry='$acyear' and c.courseID='".$_SESSION['courseId']."'  and c.subcrsID='$subcrsID' and c.studentID=s.studentID and e.indexNo=c.indexNo and e.mark2='AB'";
