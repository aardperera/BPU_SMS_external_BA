...
$db = new DBOperations();
	...
	//	print $_SESSION['courseID'] ;
		...
		$query = "INSERT INTO sup_dtl SET  nic='$nic', title='$title', nameEnglish='$nameEnglish', nameSinhala='$nameSinhala', addressE1='$addressE1', addressE2='$addressE2', addressE3='$addressE3', addressS1='$addressS1', addressS2='$addressS2', addressS3='$addressS3', contactNo='$contactNo', email='$email'";
		...
		header("location:sup_details.php");
...
<br/><br/>
<p><input name="btnCancel" type="button" value="Cancel" onclick="document.location.href = 'index.php';"  class="button" style="width:60px;"/>&nbsp;&nbsp;&nbsp;
...
<?php
  ...
  ob_end_clean();
   $pagetitle = "New Supervisor - Students - Student Management System (External) - Buddhist & Pali University of Sri Lanka";
  $navpath = "<ul><li><a href='index.php'>Home </a></li><li><a href='sup_details.php'>Supervisors </a></li><li>New Student</li></ul>";
  //Apply the template
