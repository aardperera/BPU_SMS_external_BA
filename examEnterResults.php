  ...
  if (isset($_POST['btnSubmit']))
	{
		...
		while ($row=  $db->Next_Record($resultall))
		{
			...
			//print $marks ;
			//print 'g';
			$queryexist = "Select * from exameffort where subjectID='$SubjectID' and indexNo='$indexNo' and acYear='$acyear' and exYear='$exyear'";
			...
			if ($marks!=""){
				...
				$resultinsert = $db->executeQuery("INSERT INTO exameffort (indexNo,subjectID,mark1,acYear,exYear) VALUES ('$indexNo', $SubjectID, '$marks', '$acyear','$exyear')");
...
<br/>
 <table width="230" class="searchResults">
	...
	<tr>
      ...
      <td><label>
		<?php  
		 $query123 = "Select * from exameffort where subjectID='$SubjectID'  and acYear='$acyear' limit 1"; 
