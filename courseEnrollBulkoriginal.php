...
if (isset($_POST['btnSubmit']))
	...
	while ($row1234 = $db->Next_Record($result1234))
		...
		if(isset($_POST['stu'.$row1234['Enroll_id']]))
		{
			...
			$query12345 = "SELECT a.subjectID, b.codeEnglish FROM `subject_enroll` AS a, subject AS b WHERE a.Enroll_id = '$enrlid' AND a.subjectID = b.subjectID ;";
	...
	while ($row1234 = $db->Next_Record($result1234))
		...
		if(isset($_POST['stu'.$row1234['Enroll_id']]))
		{
			...
			$query12345 = "SELECT a.subjectID, b.codeEnglish FROM `subject_enroll` AS a, subject AS b WHERE a.Enroll_id = '$enrlid' AND a.subjectID = b.subjectID order by a.regNo;";
			$result12345 = $db->executeQuery($query12345);
