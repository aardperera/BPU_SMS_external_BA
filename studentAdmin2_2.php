<?php
 ...
 //print $_SESSION['courseID'] ;
  ...
  $query = "SELECT * FROM student_a WHERE courseID='".$_SESSION['courseId']."' and nic=$nic";
  }
 ...
 ?>
  ...
  <table style="margin-left:8px" class="panel">
    <tr>
      ...
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td><input name="btnAuto" type="button" value="Bulk Enrollment" onclick="document.location.href = 'courseEnrollBulk.php';" class="button" style="width:100px;"/></td>
	...
	<tr>
	  ...
	  echo "Student ID:&nbsp;";
	   ...
	   <td>NIC : 
       <input name="txtSearchN" type="text" id="txtSearchN" maxlength="10" onChange="document.form1.submit()" /></td>
...
<?php
				...
				if($subCID!="" && $studentID==''){
					...
					$sql1="SELECT *  FROM student_a WHERE `nic`= '".$nic."'";
					$Result = executeQuery($sql1);
					}
					*/	
        ...
        <td><input name="btnEnroll" type="button" value="Enrollments" onclick="document.location.href ='courseEnroll.php?studentID=<?php echo $row['studentID'] ?>&date= <?php $date?>'" class="button" style="width:80px;" /></td>
	</tr>
				<?php
...
?>
	<tr>
        ...
        <td><input name="btnEdit" type="button" value="Edit" onclick="document.location.href ='studentEdit.php?studentID=<?php echo $row['studentID'] ?>'" class="button" style="width:60px;"/></td>
        <td><input name="btnDelete" type="button" value="Delete" class="button" onclick="if (MsgOkCancel()) document.location.href ='studentAdmin.php?cmd=delete&studentID=<?php echo $row['studentID'] ?>'" style="width:60px;" /></td>
        <td><input name="btnEnroll" type="button" value="Enrollments" onclick="document.location.href ='courseEnroll.php?studentID=<?php echo $row['studentID'] ?>&date=<?php echo $date?>'" class="button" style="width:80px;" /></td>
	</tr>
<?php
  }
