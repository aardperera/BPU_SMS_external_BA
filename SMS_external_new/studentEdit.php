...
<form method="post" action="studentEdit.php?studentID=<?php echo $studentID; ?>" onsubmit="return validate_form(this);" class="plain">
  <table class="searchResults">
	...
	<ol>
		...
		<input name="txtCivilStatus" type="radio" value="Married" <?php if($result['txtCivilStatus']=="Married"){ echo "checked";}?>/></li>
		<li>Unmarried&ensp;&ensp;
		<input name="txtCivilStatus" type="radio" value="Unmarried" <?php if($result['txtCivilStatus']=="Unmarried"){ echo "checked";}?>/></li>
	</ol>  
