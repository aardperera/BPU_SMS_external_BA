...
$db = new DBOperations();
	...
	if (isset($_POST['btnSubmit']))
	{
		...
		$query = "UPDATE course SET courseCode='$courseCode',nameEnglish='$nameEngslih', nameSinhala='$nameSinhala', courseType='$courseType' WHERE courseID='$courseID'";
...
<table class="searchResults">
	...
	<tr>
    	<td>Course Code : </td><td><input name="txtCourseCode" type="text" value="<?php echo $row['courseCode'] ?>" /></td>
    </tr>
    <tr>
