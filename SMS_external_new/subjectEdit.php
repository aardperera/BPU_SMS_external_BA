...
$db = new DBOperations();
 // 	include('authcheck.inc.php');
	...
	if (isset($_POST['btnSubmit']))
	{
		...
		$query = "UPDATE subject SET courseID='$courseID',subcrsID='subcrsID', Compulsary='$compulsary',codeEnglish='$codeEnglish', nameEnglish='$nameEngslih', codeSinhala='$codeSinhala', nameSinhala='$nameSinhala', faculty='$faculty', level='$level', semester='$semester', creditHours='$chours' WHERE subjectID='$subjectID'";
...
<table class="searchResults">
	<tr>
	  <td>CourseID:</td>
	  <td><label>
	  <input name="courseID" type="text" value="<?php echo $row['courseID']."-" . $row['courseCode']  ?>" />
	  </label></td>
    </tr>
	<!--<tr>
	  <td>Compulsary:</td>
