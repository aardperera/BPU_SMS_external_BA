...
//$query = "SELECT regNo,indexNo,crs_enroll.courseID,course.nameEnglish,yearEntry ,subject.subjectID FROM crs_enroll ,subject ,course WHERE crs_enroll.courseID = subject.courseID AND crs_enroll.courseID = course.courseID AND subject.courseID = course.courseID AND crs_enroll.studentID = '$studentID' ";
...
<br/>
  <table class="searchResults">
	<tr>
    	<th>Reg. No.</th><th>Course</th><th>Course ID</th><th>Subject Code</th><th>Subject Name</th><th>Entry Year</th><th colspan="3"></th>
    </tr>
...
?>
	<tr>
		...
		<td width = 250><?php echo $row['courseID'] ?></td>
