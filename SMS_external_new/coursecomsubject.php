...
$db = new DBOperations();
  ...
  $query = "SELECT a.combinationID,a.Description,b.courseCode,a.subcrsID, b.courseID,c.description,s.nameEnglish  FROM course_combination as a,course as b,subject s, crs_sub c WHERE a.CourseID=b.courseID and a.CourseID=c. CourseID and a.subcrsID= c.subcrsID ";
