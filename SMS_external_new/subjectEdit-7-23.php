...
$db = new DBOperations();
 // 	include('authcheck.inc.php');
	...
	if (isset($_POST['btnSubmit']))
	{
		...
		$query = "UPDATE subject SET courseID='$courseID', Compulsary='$compulsary',codeEnglish='$codeEnglish', nameEnglish='$nameEngslih', codeSinhala='$codeSinhala', nameSinhala='$nameSinhala', faculty='$faculty', level='$level', semester='$semester', creditHours='$chours' WHERE subjectID='$subjectID'";
