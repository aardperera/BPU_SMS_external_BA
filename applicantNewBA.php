...
if (isset($_POST['btnSubmit'])) {
    ...
    $query = "SELECT * FROM ba_applicant WHERE applicantID='$studentID' and acyear='$acyear'";
    $result = $db->executeQuery($query);

    $query = "SELECT * FROM ba_applicant WHERE nic='$nic' and acyear='$acyear' and courseID='" . $_SESSION['courseId'] . "'";
    ...
    if($db->numRows($result) > 0){
        ...
        $queryq = "INSERT INTO ba_qualifications SET applicantID='$studentID', OL='$ol',AL='$al', HDEnglish='$diplomaE', HDBud='$diplomaB', HDPali='$diplomaP',
        	HDSans='$diplomaS',	HDDaham='$diplomaD',HDTamil='$diplomaT', Darmacharya='$Darmacharya', PrachinaM='$PrachinaM', PrachinaP='$PrachinaP',Degree='$Degree',Ctest='$Ctest'";
       //print $queryq;
                ...
                $querysub = "INSERT INTO ba_subjects SET applicantID='$studentID', bp='$bp',bc='$bc', pali='$pali', san='$san', eng='$eng',
                arch='$arch',rs='$rs', esin='$esin', bcon='$bcon', tamil='$tamil', sin='$sin',ctamil='$ctamil' ";
           //print $queryq;
          //print ("***************************");
           //print $querysub;
        ...
        header("location:applicantAdminBA.php");
...
/*
        for ($i = 1; $i <= 10; $i++) {
            if (isset($_POST['q_institute' . $i])) {
                ...
                $query = "INSERT INTO ba_applicant_qualification SET degree='$degree', institute='$institute', indexno='$indexno', `year`='$year', subjects='$subjects', class='$class', contacts='$contacts', applicantID='$studentID'";
                $result = $db->executeQuery($query);
            }
        }
...
$query = "SELECT applicantID FROM  ba_applicant";
...
<form method="post" action="" onsubmit="return validate_form(this);" class="plain">
    <table>
        ...
        <tr>
            <td height="26">Name in Sinhala <span class="red-star">*</span> : </td>
            <td colspan="3"><input name="txtNameSinhala" type="text" value="" maxlength="400" style="width:500px"
                    required /></td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="4">
                ...
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                <input name="txtField" type="radio" value="Languages Studies"> Languages Studies &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
	  ...
	  <table border="0">
		...
		<td></td><td>Buddist Philosophy</td> <td><input name="txtbp" type="checkbox" value="1" /> </td>
		</tr>
		<tr>
		<td></td><td>Buddist Culture</td> <td><input name="txtbc" type="checkbox" value="1" /> </td>
		</tr>
        <tr>
		<td></td><td>Pali</td> <td><input name="txtpali" type="checkbox" value="1" /> </td>
		</tr>
        <tr>
		<td></td><td>Sanskrit</td> <td><input name="txtsan" type="checkbox" value="1" /> </td>
		</tr>
        <tr>
		<td></td><td>English</td> <td><input name="txteng" type="checkbox" value="1" /> </td>
		</tr>
        <tr>
		<td></td><td>Archaeology</td> <td><input name="txtarch" type="checkbox" value="1" /> </td>
		</tr>
        <tr>
		<td></td><td>Religious Study</td> <td><input name="txtrs" type="checkbox" value="1" /> </td>
		</tr>
        <tr>
		<td></td><td>Sinhala</td> <td><input name="txtsin" type="checkbox" value="1" /> </td>
		</tr>
        <tr>
		<td></td><td>Tamil</td> <td><input name="txtctamil" type="checkbox" value="1" /> </td>
		</tr>
        <tr>
		<td>2.</td><td>Elective Subjects</td> <td> </td>
		</tr>
		<tr>
		<td></td><td>Sinhala</td> <td><input name="txtesin" type="checkbox" value="1" /> </td>
		</tr>
        <tr>
		<td></td><td>Buddist Councelling</td> <td><input name="txtbcon" type="checkbox" value="1" /> </td>
		</tr>
        <tr>
		<td></td><td>Tamil</td> <td><input name="txttamil" type="checkbox" value="1" /> </td>
		</tr>
	  ...
	  <table border="0">
		<tr>
		<td>1.</td><td>O/L</td> <td><input name="txtol" type="checkbox" value="1" /> </td>
		</tr>
		<tr>
		<td>2.</td><td>A/L</td> <td><input name="txtal" type="checkbox" value="1" /> </td>
		</tr>
        <tr>
		<td>3.</td><td>Higher Diploma</td> <td> </td>
		</tr>
		<tr>
		<td></td><td>English</td> <td><input name="txtdiplomaE" type="checkbox" value="1" /> </td>
		</tr>
        <tr>
		<td></td><td>Buddhisum</td> <td><input name="txtdiplomaB" type="checkbox" value="1" /> </td>
		</tr>
        <tr>
		<td></td><td>Pali</td> <td><input name="txtdiplomaP" type="checkbox" value="1" /> </td>
		</tr>
        <tr>
		<td></td><td>Sanskrit</td> <td><input name="txtdiplomaS" type="checkbox" value="1" /> </td>
		</tr>
        <tr>
		<td></td><td>DahamSarasawiya</td> <td><input name="txtdiplomaD" type="checkbox" value="1" /> </td>
		</tr>
        <tr>
		<td></td><td>Tamil</td> <td><input name="txtdiplomaT" type="checkbox" value="1" /> </td>
		</tr>
		<tr>
		<td>4.</td><td>Dharmacharya</td> <td><input name="txtdharma" type="checkbox" value="1" /> </td>
		</tr>
		<tr>
		<td>5.</td><td>Prachina</td> <td> </td>
		</tr>
		<tr>
		<td> </td><td>Prachina Maddhyam</td> <td><input name="txtpraM" type="checkbox" value="1" /></td>
		</tr>
		<tr>
		<td> </td><td>Prachina Praramba</td> <td><input name="txtpraP" type="checkbox" value="1" /></td>
		</tr>
        <tr>
		<td>6.</td><td>Degree</td> <td><input name="txtdegree" type="checkbox" value="1" /> </td>
		</tr>
        <tr>
		<td>7.</td><td>Common Test</td> <td><input name="txtctest" type="checkbox" value="1" /> </td>
		</tr>
        ...
        <tr>
            ...
            <td>
                <input id="payment" name="payment" type="number" min="0" max="999999" value="750" required />
            </td>
        </tr>
