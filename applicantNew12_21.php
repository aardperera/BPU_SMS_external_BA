...
<form method="post" action="" onsubmit="return validate_form(this);" class="plain">
    <table>
        <tr>
		    <td></td>
            <td>Student ID : </td>  
            <td colspan="1"><input name="txtStudentID" type="text" value="" maxlength="20"/></td>
            <td>Academic Year : </td>  
        ...
        <tr>
            ...
            <td colspan="3"><input name="txtNameEnglish" type="text" value="" style="width:500px" maxlength="100" required/></td>
        </tr>
        <!-- 
        <tr>
            <td>Name (Sinhala) : </td>
        ...
        <tr>
            ...
            <td colspan="3"><input name="txtInitials" type="text" value="" maxlength="200" style="width:500px" required/></td>
        </tr>

        <tr>
            <td height="26">Full Name in English : </td>
            <td  colspan="3"><input name="txtFullNameEnglish" type="text" value="" maxlength="400" style="width:500px" required/></td>
        </tr>

        <tr>
		<td rowspan="2" style="vertical-align:top;">2.</td>
            <td valign="top">Address (Sinhala) : </td>
            <td  colspan="3"><input name="txtAddressS1" type="text" value="" maxlength="200" style="width:500px" required/>
                <br />
        ...
        <tr>
            ...
            <td  colspan="3"><input name="txtAddressE1" type="text" value="" maxlength="200" style="width:500px" required/>
                <br />
        ...
        <tr>
		    <td></td>
            <td>Email : </td>
            <td  colspan="3"><input style="width:500px;" name="txtEmail" type="email"  maxlength="60" value="" required/></td>
        </tr>
        ...
        <tr>
		    <td>9.</td>
            <td>Birthday : </td>
            <td><input name="txtBirthday" type="text" value="" onclick="scwShow(this,event);" onfocus="scwShow(this,event);" readonly required/></td>
            <td>Age : </td>
		...
		<td>15.</td>
            ...
            <td colspan="3"><input name="txtEmployer" type="text" value="" maxlength="50" style="width:500px;" required/></td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input name="txtDegree" type="radio" value="P.G.D. - Buddhist Studies" checked> P.G.D. - Buddhist Studies &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        ...
        <td></td>
            <td>1. O/L</td>
            <td><input name="txtol" type="checkbox" value="YES" /> </td>
        </tr>
        <tr>
        <td></td>
            <td>2. A/L</td>
            <td><input name="txtal" type="checkbox" value="YES" /> </td>
        </tr>
        <tr>
        <td></td>
            <td>3. Diploma</td>
            <td><input name="txtdiploma" type="checkbox" value="YES" /> </td>
        </tr>
        <tr>
        <td></td>
            <td>4. Higher Diploma</td>
            <td><input name="txthigher_Diploma" type="checkbox" value="YES" /> </td>
        </tr>
        <tr>
        <td></td>
            <td>5. First Degree</td>
            <td><input name="txtFirst_Degree" type="checkbox" value="YES" /> </td>
        </tr>
        <tr>
        <td></td>
        ...
        <td></td>
            <td>   One Year </td>
            <td><input name="txtPost_One_Year" type="checkbox" value="YES" /></td>
        </tr>
        <tr>
        <td></td>
            <td>   Two Years</td>
            <td><input name="txtPost_Two_Year" type="checkbox" value="YES" /></td>
        </tr>
        <tr>
        <td></td>
            <td>7. Others : </td>
