...
$db = new DBOperations();
 ...
 if (isset($_POST['courseID']))
	...
	if (isset($_POST['btnSubmit']))
	{
		...
		$query = "INSERT INTO subject SET courseID='$courseID ', Compulsary='$compulsary', codeEnglish='$codeEnglish', nameEnglish='$nameEngslih', codeSinhala='$codeSinhala', nameSinhala='$nameSinhala', faculty='$faculty', level='$level',semester='$semester',creditHours='$chours'";
