  ...
  if (isset($_POST['btnSubmit']))
	{
		...
		while ($row=  $db->Next_Record($resultall))
		{
            ...
            if ($count == 0) {
                ...
                $regNoQuery = "SELECT regNo FROM crs_enroll WHERE indexNo = '$indexNo' AND yearEntry = '$acyear'";
                ...
                if ($regNo !== null) {
                    ...
                    $insertQuery = "INSERT INTO crs_enrollR (regNo, indexNo, studentID, courseID, yearEntry, subcrsID) 
                                    SELECT regNo, indexNo, studentID, '5' AS courseID, '$acyear' AS yearEntry, '$subcrsID' AS subcrsID
                                    FROM crs_enroll WHERE indexNo = '$indexNo' AND yearEntry = '$acyear'";
