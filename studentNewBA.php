...
<?php
	...
	{
		$studentID = cleanInput($_POST['txtStudentID']);
		$nic = cleanInput($_POST['txtNic']);
		...
		$employment = cleanInput($_POST['txtEmployment']);
		$employer = cleanInput($_POST['txtEmployer']);
		...
		$query = "INSERT INTO student SET studentID='$studentID', nic='$nic', title='$title', nameEnglish='$nameEnglish', nameSinhala='$nameSinhala', addressE1='$addressE1', addressE2='$addressE2', addressE3='$addressE3', addressS1='$addressS1', addressS2='$addressS2', addressS3='$addressS3', contactNo='$contactNo', email='$email', birthday='$birthday', citizenship='$citizenship',civilStatus='$civilStatus', acyear='$acyear',employment='$employment', employer='$employer',courseID='".$_SESSION['courseId']."'";
...
<form method="post" action="" onsubmit="return validate_form(this);" class="plain">
  <table class="searchResults">
    ...
    <tr> 
      <td>Academic Year: </td>
      <td><input name="txtacyear" type="text" value="" /></td>
    </tr>
    <tr>
      <td>NIC No. : </td>
      <td><input name="txtNic" type="text" value="" maxlength="12" /></td>
    </tr>
    <tr> 
      <td>Title : </td>
