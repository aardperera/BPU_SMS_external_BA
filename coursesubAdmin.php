...
$db = new DBOperations();
  ...
  $query = "SELECT b.courseCode,a.courseID,a.subcrsID,a.description,a.id FROM crs_sub as a,course as b where a.CourseID=b.courseID";
...
?>
   ...
   <td><input name="btnDetails" type="button" value="Details" onclick="document.location.href ='coursesubdetails.php?combinationID=<?php echo $row['id']?>'"  class="button" style="width:60px;"/></td>
   
      <td><input name="btnEdit" type="button" value="Edit" onClick="document.location.href ='subcourseEdit.php?combinationID=<?php echo $row['id'] ?>'" class="button" style="width:60px;"/></td>
