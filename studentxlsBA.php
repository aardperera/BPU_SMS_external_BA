...
$query = "SELECT * FROM crs_enroll WHERE courseID='5' and yearEntry='$acyear' and subcrsID='7' ";
//print $query;
...
//====================================================== Getting Subjects ========================
$queryenroll = "Select Enroll_id from crs_enroll where  studentID='$studentID'  and yearEntry='$acyear' and courseID='5' and subcrsID='7' ";
//print $queryenroll;
