...
if (isset($_GET['cmd']) && $_GET['cmd'] == "delete") {
	...
	$delQuery = "DELETE FROM dip_student WHERE studentID ='$regNo'";
...
if (isset($_GET['cmd']) && $_GET['cmd'] == "find") {
	...
	$srcQuery = "Select studentID FROM dip_student WHERE nic ='$nic'";
	//print $srcQuery;
...
//$nic='';
//if ($nic == "") {
$query = "SELECT * FROM dip_student WHERE courseID='" . $_SESSION['courseId'] . "'";
//} else {
		...
		<table class="searchResults">
			...
			while ($row = $db->Next_Record($pageResult)) {
				...
				<tr>
					...
					<td>
						<?php echo $row['addressE1'] . $row['addressE2'] . $row['addressE3'] ?>
					</td>
