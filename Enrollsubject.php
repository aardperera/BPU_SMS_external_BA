	...
	<tr>
      ...
      <td><label>
     	  <?php
								...
								echo '<select name="regno" id="regno"  onChange="document.form1.submit()" class="form-control">'; // Open your drop down box
							...
							?>
							 ...
							 <script>
								document.getElementById('regNo').value = "<?php echo $regNo;?>";
							</script>
 </label>
		</td>
...
<?php
 $queryall = "Select * from crs_enroll c,subject_enroll s,subject j where  c.yearEntry='$acyear' and c.courseID='".$_SESSION['courseId']."'  and c.subcrsID='$subcrsID' and c.Enroll_id=s.Enroll_id and c.regNo='$regNo' and j.subjectID=s.subjectID ";
//print $queryall;
