...
if ( isset( $_POST['pfa'] ) )
 {
    $pfa = $db->cleanInput($_POST['pfa']);
}
//print $acyear;
if (isset($_POST['btnSubmit']))
	{
			header("location:studentDetailsView.php?courseID=$courseID&subcrsID=$subcrsID&acyear=$acyear&pfa=$pfa");
	}
...
//echo '<option value="all">Select All</option>';
				echo '<option value="a">All registered Students</option>';
		echo '<option value="b">All Enrolled Students</option>';
		echo '<option value="c">Not Enrolled Students</option>';
while ( $row =  $db->Next_Record( $result ) ) {
