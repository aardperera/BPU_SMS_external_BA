...
{
    header( "location:signingSheet.php?courseID=$courseID&subcrsID=$subcrsID&acyear=$acyear&medium=$medium&SubjectID=$SubjectID&examc=$examc" );
}
//print $acyear;
