...
if (isset($_POST['btnSubmit']))
	{
			header("location:mediumView.php?courseID=$courseID&subcrsID=$subcrsID&acyear=$acyear&medium=$medium");
	}
...
?>
        ...
        <tr>
            ...
            <td><label>
                    <?php
echo '<select name="medium" id="medium" onChange="document.form1.submit()" class="form-control">';
// Open your drop down box
echo '<option value="1">Sinhala</option>';
