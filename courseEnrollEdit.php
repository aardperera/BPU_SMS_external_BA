...
<table class="searchResults">
    ...
    <tr>
    	<td>Student ID : </td><td><input name="txtStudentID" type="text" value="<?php cho $row['studentID']; ?>" readonly="readonly" /></td>
    </tr>
...
?>
	<tr>
        ...
        <td><input name="check<?php echo $row['subjectID'] ?>" id="myCheck" <?php myFunction($row['courseID']); ?>  type="checkbox" value="check<?php echo $row['subjectID'] ?>" /> </td>
        </tr>
<?php
  }
