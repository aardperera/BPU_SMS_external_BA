...
<script type="text/javascript" language="javascript">
	...
	function quickSearch3() {
		...
		if (acyear == "")
			...
			document.location.href ='studentAdmin.php?cmd=find&acyear=' + acyear;
	}
...
<?php
 ...
 if ($acyear!=' '){
	$srcQuery = "Select studentID FROM student_a WHERE acyear ='$acyear'";
 }
	 //print $srcQuery;
	...
	<table style="margin-left:8px" class="panel">
      ...
      ?>
			...
			<td>
				...
				<?php
      echo "Academic Year:&nbsp;";
      echo '<select name="acyear" id="acyear" onchange="myFunction()" onChange="document.form1.submit()" class="form-control">'; // Open your drop down box
      ...
      ?>
			...
			<td>
				<input type="submit" name="btn" value="&nbsp;View&nbsp;" onclick="quickSearch3();">
			</td>
			<td>
