...
$time=strtotime($year_month . '-01');
$month = date("F",$time);

switch($month){
    case 'January'     : $month_ = "ජනවාරි"; break;
	case 'February'    : $month_ = "පෙබරවාරි"; break;
	case 'March'	   : $month_ = "මාර්තු"; break;
	case 'April'	   : $month_ = "අප්‍රේල්"; break;
	case 'May'	       : $month_ = "මැයි"; break;
	case 'June'	       : $month_ = "ජූනි"; break;
	case 'July'	       : $month_ = "ජූලි"; break;
	case 'August'	   : $month_ = "අගෝස්තු"; break;
	case 'September'   : $month_ = "සැප්තැම්බර්"; break;
	case 'October'     : $month_ = "ඔක්තෝබර්"; break;
	case 'November'    : $month_ = "නොවැම්බර්"; break;
	case 'December'    : $month_ = "දෙසැම්බර්"; break;
}
...
<link rel="stylesheet" href="css/resultsheet.css" type="text/css">
...
<p align="center">
	This is to certify that '.$ename.' sat the Master of Arts Degree Examination in English Medium held in ' . $monthe . ' <br>
...
<table align="center" width="80%" cellspacing="15" cellpadding="5" border="0" height="10%">
<tr>
    <td align="left">Result Valid From : ' . $date . '</td>
    </tr>
...
<html>
	...
	<div class="page">
		...
		<form id = "form1" method = "POST" action = "">
			...
			<p align = "center">' . $months . ' මස පැවැති උක්ත පරීක්ෂණයට විභාග අංක '.$index_No.' යටතේ පෙනී සිටි '.$sname.' එම <br/> පරීක්ෂණයෙන් සාමාර්ථය ලබා ගෙන
