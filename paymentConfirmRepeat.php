...
//echo("button pressed");
//    exit();
	$queryall = "Select * from crs_enrollR where  yearEntry='$acyear' and courseID='".$_SESSION['courseId']."'  and subcrsID='$subcrsID' order by regNo";
//    echo $queryall . '<br/>';
//    exit;
	...
	while ($row =  $db->Next_Record($resultall))
	{
		...
		$queryexist = "Select * from paymentEnrollR where enroll_id='$Enrollid'";
		//echo $queryexist . '<br/>';
		...
		if($value==0){
			$sqlinsert = "INSERT INTO paymentEnrollR (enroll_id, payment1, payment2, payment3, amount1, amount2, amount3, date1, date2,  date3 ) VALUES ($Enrollid, ";
			...
			$sqlupdate = "UPDATE paymentEnrollR SET ";
...
?>
<h1>Enter Repeat Student Payment Details</h1>
<br />
...
<form method="post" action="" name="form1" id="form1" class="plain">
    ...
    <table class="searchResults">
        <tr>
            ...
            <th colspan="3">Exam Fee</th>
            <th colspan="3">Seminar Fee</th>
