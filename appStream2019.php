...
<form method="post" action="" name="form1" id="form1" class="plain">
    ...
    <table class="searchResults">
        <tr>
            ...
            <th  style="width:30%">Enrolled Subjects</th>
        ...
        <?php
		$queryall = "Select * from student_a where acyear='$acyear' and courseID='5' ";
       //print $queryall;
...
$querysubject = "Select * from student_a where  studentID='$applicantID'  ";
...
$queryenroll = "Select Enroll_id from crs_enroll where  studentID='$applicantID'  and yearEntry='$acyear' and courseID='5' and subcrsID='8' ";
//print $queryenroll;
$enrollid=' ';
