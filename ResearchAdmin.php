<?php
 ...
 $db = new DBOperations();
  ...
  if (isset($_GET['cmd']) && $_GET['cmd']=="delete")
  {
	...
	$delQuery = "DELETE FROM subject_R WHERE id ='id'";
  ...
  // counting the offset
	...
	$pageResult = $db->executeQuery($delQuery);
...
?>
  ...
  <table style="margin-left:8px" class="panel">
    <tr>
      <td><input name="btnNew" type="button" value="New" onClick="document.location.href = 'ResearchNew.php';" class="button" style="width:60px;"/> </td>
      <td>&nbsp;</td>
...
?>
	<tr>
        ...
        <td><?php echo $row['reg_date'] ?></td>
		 <td><?php echo $row['report_sub_date'] ?></td>
      ...
      <td><input name="btnEdit" type="button" value="Edit" onClick="document.location.href ='subcourseEdit.php?combinationID=<?php echo $row['id'] ?>'" class="button" style="width:60px;"/></td>
        <td><input name="btnDelete" type="button" value="Delete" class="button" onClick="if (MsgOkCancel()) document.location.href ='ResearchAdmin.php?cmd=delete&id=<?php echo $row['id'] ?>'" style="width:60px;" /></td>
