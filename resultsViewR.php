...
<center>
    <?php
        ...
        if (isset($_POST['btn-save'])) {
            $dist = $_POST['year'];
  			header("location:resultExcelR.php?courseID=$courseID&subcrsID=$subcrsID&acyear=$acyear&effortNo=$effortNo");
        }
    ?>
    ...
    <h4>Detailed Result Sheet for Repeat Examination</h4>
</center>
