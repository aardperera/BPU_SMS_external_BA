...
<html>
	...
	<body>
		<form name = "form119" id = "form119" method = "POST" action = "resultSheet.php">
			...
			<tr>
			<td>Index Number : </td>
			<td><select name="lstIndexNo" id="lstIndexNo" style="width:auto" onchange = "int_check(this)">
			...
			for ($i=0;$i<$db->Row_Count($result);$i++)
			{
				...
				$rNameSinhala = mysql_result($result,$i,"nameSinhala");
			...
			<tr>
			<td>Medium : </td><td><select name="lstMedium" id = "lstMedium" onchange = "medium_check(this)">
