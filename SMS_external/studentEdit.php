...
<form method="post" action="studentEdit.php?studentID=<?php echo $studentID; ?>" onsubmit="return validate_form(this);" class="plain">
  <table class="searchResults">
    ...
    <tr> 
      <td>Nationality : </td>
      <td><input name="txtNationality" type="text" value="<?php echo $row['nationality'] ?>" /></td>
    </tr>
    <tr> 
      <td>Religion : </td>
      <td><input name="txtReligion" type="text" value="<?php echo $row['religion'] ?>" /></td>
    </tr>
    <tr> 
      <td>Civil Status : </td>
      <td><input name="txtCivilStatus" type="text" value="<?php echo $row['civilStatus'] ?>" /></td>
    </tr>
    <tr> 
      <td>Employment : </td>
    ...
    <tr> 
      <td>Gurdian Name : </td>
      <td><input name="txtGuardName" type="text" value="<?php echo $row['guardName'] ?>" /></td>
    </tr>
    <tr> 
      <td>Gurdian Address : </td>
      <td><input name="txtGuardAddress" type="text" value="<?php echo $row['guardAddress'] ?>" /></td>
    </tr>
    <tr> 
      <td>Gurdian Contact No. : </td>
      <td><input name="txtGuardContactNo" type="text" value="<?php echo $row['guardContactNo'] ?>" /></td>
    </tr>
  </table>
<br/><br/>
