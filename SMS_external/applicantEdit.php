...
<form method="post" action="applicantEdit.php?studentID=<?php echo $studentID; ?>"
    ...
    <table>
        <tr>
            <td></td>
            <td>Student ID : </td>
            <td colspan="1"><input name="txtStudentID" type="text" value="<?php echo $row['studentID']; ?>" /></td>
            <td>Academic Year : </td>
            <td colspan="1"><input name="txtacyear" type="text" value="<?php echo $row['acyear']; ?>" /></td>
        </tr>
        ...
        <tr>
            ...
            <td>City : </td>
            <td>
                <input name="txtCity" type="text" value="<?php echo $row['city']; ?>" style="width: 150px;" />
            </td>
        ...
        <tr>
            ...
            <td colspan="3"><input name="txtDistrict" type="text" value="<?php echo $row['districtstate']; ?>" /></td>
        </tr>

        <tr>
            <td>5.</td>
            <td>Country : </td>
            <td colspan="3"><input name="txtCountry" type="text" value="<?php echo $row['country']; ?>" /></td>
        </tr>
        ...
        <tr>
            ...
            <td>Age : </td>
            <td><input name="txtAge" type="number" value="" /></td>
        </tr>
    ...
    <br /><br />
    <p><input name="btnCancel" type="button" value="Cancel" onclick="document.location.href = 'studentAdmin.php';"
